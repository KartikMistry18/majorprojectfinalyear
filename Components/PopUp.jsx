          ...
          <div className=" border-0  rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="relative p-6 flex-auto ">
              ...
              <input
                ...
                placeholder="Amount"
                required
                className="flex-grow w-full  h-12 px-4 mb-2  transition duration-200 bg-white border border-gray-300 rounded shadowsm  appearance-none focus:border-deep-purple-accent-500 focus:outline-none focus:shadow-outline"
                id="firstName"
                name="firstName"
              />
            ...
            <div className="flex items-center justify-end border-t border-solid border-slate-200 rounded-b ">
              ...
              <button
                className="background text-white active:bg-emerald-600 font-bold-uppercase text-sm px-6 py-3rounded shadow  hover:shadow-lg outline-none
